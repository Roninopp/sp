...
async def start_aries():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
            await idk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
            await idk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
            await idk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
            await idk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
            await ydk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
            await ydk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
            await ydk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
            await ydk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
            await wdk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
            await wdk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
            await wdk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
            await wdk(functions.channels.JoinChannelRequest(channel="@RONIN_Fighters_Fd"))
